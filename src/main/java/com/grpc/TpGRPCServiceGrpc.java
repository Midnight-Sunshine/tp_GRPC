...
public final class TpGRPCServiceGrpc {

  private TpGRPCServiceGrpc() {}
  ...
  public static io.grpc.MethodDescriptor<com.grpc.Reservation.ReservationRequest,
    ...
    if ((getCreateReservationMethod = TpGRPCServiceGrpc.getCreateReservationMethod) == null) {
      synchronized (TpGRPCServiceGrpc.class) {
        if ((getCreateReservationMethod = TpGRPCServiceGrpc.getCreateReservationMethod) == null) {
          TpGRPCServiceGrpc.getCreateReservationMethod = getCreateReservationMethod = 
  ...
  public static io.grpc.MethodDescriptor<com.grpc.Reservation.ReservationRequest,
    ...
    if ((getGetReservationMethod = TpGRPCServiceGrpc.getGetReservationMethod) == null) {
      synchronized (TpGRPCServiceGrpc.class) {
        if ((getGetReservationMethod = TpGRPCServiceGrpc.getGetReservationMethod) == null) {
          TpGRPCServiceGrpc.getGetReservationMethod = getGetReservationMethod = 
              io.grpc.MethodDescriptor.<com.grpc.Reservation.ReservationRequest, com.grpc.Reservation.ReservationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
